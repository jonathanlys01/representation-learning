...
#python3 train.py --model ae --n_epochs 100 --name ae --dataset cifar --batch_size 512
#python3 train.py --model conv --n_epochs 100 --name conv --dataset cifar --batch_size 512
...
python3 train.py --model pca --n_epochs 200 --name pca --dataset cifar -b 512
python3 train.py --model pca --n_epochs 500 --name pca_long --dataset cifar -b 512
